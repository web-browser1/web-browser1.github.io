...
// const c_rectangle = new PIXI.Sprite(texture);
 ...
 // setup events for mouse + touch using
  ...
  /* c_rectangle
        ...
        let positionX = ongoingTouches[0].pageX;
        let positionY = ongoingTouches[0].pageY;


      //  let b_x = ((scaleRx * start_p) - start_p)/2;

      //  let gx = Math.abs(cx - rx)
      ...
      /*  let cx1 = Math.abs((rx + dx) - start_p);
     ...
     //  + "  rx: " + rx  + "   ry: " + ry + "  cx1: " + cx1 );
          ...
          // console.log("event touches 0: " +   ongoingTouches[0].pageX );
            ...
            if( ongoingTouches.length == 2 ) {
                ...
                let scale_f = Math.sqrt( Math.pow( Math.abs( ongoingTouches[0].pageX - ongoingTouches[1].pageX ), 2) 
                + Math.pow( Math.abs( ongoingTouches[0].pageY - ongoingTouches[1].pageY ), 2 ) );
