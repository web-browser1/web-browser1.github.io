...
adConfig({
    ...
    sound: 'off',                 // Is sound currently enabled within the game
 });
...
function game_loop() {
    ...
    grd.addColorStop(0, 'hsl('+((hsl_h-180))+'deg '+hsl_s+'% '+((hsl_l))+'%)');
    grd.addColorStop(1, 'hsl('+(hsl_h-180)+'deg '+(hsl_s)+'% '+((hsl_l+20))+'%)');
